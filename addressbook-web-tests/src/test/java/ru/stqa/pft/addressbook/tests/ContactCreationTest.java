...
public class ContactCreationTest {
    ...
    public void testContactCreation() {
        gotoContactCreation();
        fillContactForm(new ContactData("test", "test2", "test3", "test4", "title", "company", "address", "+796545564", "+795645123", "+795645123", "+795645123", "test@test.ru", "test@test.ru", "test@test.ru", "test@test.ru", "1995", "1995", "address 2", "123456", "notes"));
